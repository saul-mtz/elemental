...
import ExampleSource from '../components/ExampleSource';
...
export default () => {
	const menuItems = NavItems.map(function (item) {
		return (
		...
		<div>
			<header className="demo-banner demo-banner--primary">
				<Container maxWidth={768} className="demo-container">
					...
					<div className="demo-banner__buttons">
						<a className="Button Button--demo-primary" href="https://twitter.com/elementalui" target="_blank">Follow
							@ElementalUI on Twitter</a>
						<a className="Button Button--demo-link" href="https://github.com/elementalui/elemental" target="_blank">View
			...
			<div className="demo-banner demo-banner--secondary">
				<Container maxWidth={768} className="demo-container">
					...
					<ul className="demo-banner-list">
						<li>Currently under development, initially for use in <a href="http://www.keystonejs.com">KeystoneJS</a>
						</li>
				...
				<Container maxWidth={768} className="demo-container">
					...
					<div className="code-example">
						<div className="code-example__example">
							<div className="code-example__example__heading--no-rule"><span className="circle-number">1</span>Install
							</div>
						</div>
						<ExampleSource>
					...
					<div className="code-example">
						<div className="code-example__example">
							<div className="code-example__example__heading--no-rule"><span className="circle-number">2</span>Import
								styles
							</div>
						</div>
						<ExampleSource>
					...
					<div className="code-example">
						<div className="code-example__example">
							<div className="code-example__example__heading--no-rule"><span className="circle-number">3</span>Import
								the elements
							</div>
						</div>
						<ExampleSource>
					...
					<p className="note">Elemental styling is currently written in LESS so you will need a LESS compiler in your
						build process. If you are looking to get started quickly you can compile styles from the command line.</p>
					<div className="code-example">
						<div className="code-example__example">
			...
			<div className="demo-banner demo-banner--tertiary">
				<Container maxWidth={768} className="demo-container">
					...
					<p>We believe there is a need for a high quality, modular set of UI scaffolding components and controls for
						React that are built from the outset to natively implement React patterns.</p>
					<p><strong>Elemental UI</strong> has been born to solve real-world requirements in projects we work on, and
						for use in the node.js content management platform <a href="http://www.keystonejs.com"
																																	target="_blank">KeystoneJS</a>.</p>
					<p>Our goal is to create a set of functional and unopinionated components that are useful on their own or
						together, with an unobtrusive default style and flexible theme capabilities.</p>
					<p>Thanks and credit go to the many other great CSS Component libraries that have been developed and whose
						shoulders we stand on, especially Bootstrap.</p>
					<div className="demo-banner-points">
						<Row>
							<Col sm="1/3">
								<h3>Open Source</h3>
								<p>Available for use under the MIT license, built on foundations of React.js, LESS, Babel and Gulp,
									and inspired by other great projects.</p>
							</Col>
							<Col sm="1/3">
								<h3>Modern Workflows</h3>
								<p>Elemental is designed to be installed from npm and built into your project with browserify or
									webpack. You can customise it by including our LESS too.</p>
							</Col>
							<Col sm="1/3">
								<h3>Made by Thinkmill</h3>
								<p>Elemental UI is the cornerstone of Thinkmill's development suite, made by people who share a
									passion for HTML, CSS and JavaScript.</p>
							</Col>
						</Row>
					</div>
				</Container>
